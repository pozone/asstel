...
<article class="<?php echo $view_params['column_css']; ?> mk-gallery-item hover-<?php echo $view_params['hover_scenarios']; ?> <?php echo $view_params['frame_style']; ?>-frame hover-title-<?php echo $view_params['disable_title']; ?>">
