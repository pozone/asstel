...
<article class="mk-gallery-item js-gallery-item hover-<?php echo $view_params['hover_scenarios']; ?> <?php echo $mansory_pointer_css . $view_params['frame_style']; ?>-frame hover-title-<?php echo $view_params['disable_title']; ?>">
