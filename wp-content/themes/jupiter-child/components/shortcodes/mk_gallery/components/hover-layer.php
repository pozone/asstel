...
$custom_target = $view_params['el_class'] == "patrocini_home" ? "_blank" : "_self";
//echo "ww: ".$view_params['el_class'];
...
<?php if($view_params['hover_scenarios'] != 'none') { ?>
    ...
    <?php if ($view_params['hover_scenarios'] == "overlay_layer" || $view_params['disable_title'] != 'false' && !empty($image_title)) { ?>
     ...
     if (isset($link) && $link != '') { ?>
        ...
        <a href="<?php echo $link; ?>" target="<?php echo $custom_target; ?>" class="mk-image-lightbox">
