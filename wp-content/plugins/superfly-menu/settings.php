...
function sf_register_settings() {
	...
	add_settings_field('sf_fs_dynamic', "Fullscreen mode font size", 'sf_fs_dynamic_str', 'sf', 'sf_menu_items');
...
//	}
	...
	if (empty($options['sf_fs_dynamic'])) {
		$options['sf_fs_dynamic'] = '';
	}
